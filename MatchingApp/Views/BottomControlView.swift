...
//  MatchingApp
//
//  Created by ヤハタ・マサカズ on 2021/02/04.
//
import UIKit

class BottomControlView: UIView {

    let  reloadView = BottomButtonView(frame: .zero, width: 50, ImageName: "update")
    let  nopeView = BottomButtonView(frame: .zero, width: 60, ImageName: "momo")
    let  superlikeView = BottomButtonView(frame: .zero, width: 50, ImageName: "momo")
    let  likeView = BottomButtonView(frame: .zero, width: 60, ImageName: "momo")
    let  boostView = BottomButtonView(frame: .zero, width: 50, ImageName: "momo")
